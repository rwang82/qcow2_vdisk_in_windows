    ...
    )
{
    ...
    case IOCTL_STORAGE_CHECK_VERIFY2:
        {
						KdPrint(("IOCTL_DISK_CHECK_VERIFY:IOCTL_CDROM_CHECK_VERIFY:IOCTL_STORAGE_CHECK_VERIFY:IOCTL_STORAGE_CHECK_VERIFY2\n"));
            status = STATUS_SUCCESS;
            Irp->IoStatus.Information = 0;
            break;
        }
    ...
    case IOCTL_CDROM_GET_DRIVE_GEOMETRY:
        {
            ...
            ULONG           sector_size;
						...
						KdPrint(("IOCTL_DISK_GET_DRIVE_GEOMETRY:IOCTL_CDROM_GET_DRIVE_GEOMETRY\n"));
            if (io_stack->Parameters.DeviceIoControl.OutputBufferLength <
    ...
    case IOCTL_STORAGE_MEDIA_REMOVAL:
        {
						KdPrint(("IOCTL_DISK_MEDIA_REMOVAL:IOCTL_STORAGE_MEDIA_REMOVAL\n"));
            status = STATUS_SUCCESS;
            Irp->IoStatus.Information = 0;
            break;
        }
    ...
    case IOCTL_CDROM_GET_LAST_SESSION:
        {
            PCDROM_TOC_SESSION_DATA cdrom_toc_s_d;
						...
						KdPrint(("IOCTL_CDROM_GET_LAST_SESSION\n"));
            if (io_stack->Parameters.DeviceIoControl.OutputBufferLength <
            ...
            ))
        {
            ...
            case IRP_MJ_READ:
                ...
                if (buffer == NULL)
                {
            		...
            		KdPrint( ("IRP_MJ_READ Offset_H:%d Offset_L:%d Len:%d\n", io_stack->Parameters.Read.ByteOffset.HighPart, io_stack->Parameters.Read.ByteOffset.LowPart, io_stack->Parameters.Read.Length) );
                ZwReadFile(
            ...
            case IRP_MJ_DEVICE_CONTROL:
                ...
                case IOCTL_FILE_DISK_OPEN_FILE:
            				...
            				KdPrint( ("IOCTL_FILE_DISK_OPEN_FILE\n") );
                ...
                case IOCTL_FILE_DISK_CLOSE_FILE:
            				...
            				KdPrint( ("IOCTL_FILE_DISK_CLOSE_FILE\n") );
    ...
    )
{
    ...
    else if (!NT_SUCCESS(status))
    {
		...
		{
    		KdPrint( ("Open %wZ file success!\n", &ufile_name ));	
		}
		//add by rom begin
		if ( brwInitQcow2Header( device_extension->file_handle, &( device_extension->qcow2Header ) ) )
		{
			KdPrint(("brwInitQcow2Header success!\n"));	
		}
		else
		{
			KdPrint(("brwInitQcow2Header failed!\n"));	
		}
		//add end
...
//modify by rom
    ...
    device_extension->file_size.QuadPart = device_extension->qcow2Header.size;
    //end modify
